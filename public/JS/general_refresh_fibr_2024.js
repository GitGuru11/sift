...
(() => {
	window.addEventListener('load', (event) => {
		...
		function createVisualization1(overall, profile, geography) {
			...
			var panel1 = createPanel('block', 'br', '#7132D6');
			var panel2 = createPanel('review', 'rr', '#36CCBE');
			...
			document
				...
				.addEventListener('change', function (event) {
					updateAll1('industry', event.target.value);
					document
						.getElementById('filter-industry')
			...
			document
				.getElementById('filter-geography')
				.addEventListener('change', function (event) {
					updateAll1('geography', event.target.value);
					document
						.getElementById('filter-geography')
						.classList.toggle('grayed', false);
			...
			// DIFF
			var updateAll1 = function (which, filter) {
				if (which === 'industry') {
			...
			function resizeContent() {
				panel1 = createPanel('block', 'br', '#7132D6');
				panel2 = createPanel('review', 'rr', '#36CCBE');

				updateAll1(currentFilter.which, currentFilter.filter);
			}
		...
		createVisualization1(overall1, profile1, geography1);
	});
})();
