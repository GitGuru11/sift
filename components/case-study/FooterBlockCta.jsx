...
function FooterBlockCta(props) {
	let data = props.items;
	return (
        
		<section className={`${data.gatedComponent? 'GatedHide' : ''} footer-cta relative overflow-hidden xl-up:pt-[160px] !pb-[0]  wide-screen:pt-[240px] lg-up:pt-[125px] ${data.background} ${data.classes} ${data.padding}`}>
